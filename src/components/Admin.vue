              ...
              <div class="col-6">
                <div class="admin__block">
                  ...
                  <div class="news__text">
                    ...
                    <button class="button button--small-font button--small button--white" @click="setGameStage()">Наступна фаза</button>
                </div>
              </div>
              <div class="col-6">
                <div class="admin__block">
                  ...
                  <div class="news__text">
                    ...
                    <!-- <p>Ігрова інформація: {{ getCurrentGame }}</p> -->
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-12">
                <div class="admin__block">
                  ...
                  <div class="news__text">
                    ...
                    <q-btn @click='postNews(new_news.title, new_news.text, new_news.author)' type="submit" class="button button--center button--big">Запостити</q-btn>
                  </div>
                </div>
              </div>
            </div>
